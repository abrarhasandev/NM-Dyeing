...
const Page = () => {
  ...
  const fetchTypes = async () => {
    try {
      const res = await fetch("/api/menu/cloth-type");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let res;
      if (editingId) {
        res = await fetch(`/api/menu/cloth-type/${editingId}`, {
          method: "PUT",
        ...
        res = await fetch("/api/menu/cloth-type", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ name }),
        });
  ...
  const handleDelete = async () => {
    if (!deleteId) return;
    try {
      const res = await fetch(`/api/menu/cloth-type/${deleteId}`, {
        method: "DELETE",
      });
