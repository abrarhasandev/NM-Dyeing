...
export default function CalenderSavedBills({ params }) {
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden print:border-none print:shadow-none">
        <div className="p-5 sm:p-8 border-b border-gray-100 bg-white">
          ...
          <p className="text-sm font-bold text-gray-500 mt-2">
            Selected bills saved from the Calender ledger
          </p>
        </div>
          ...
          {invoices.length === 0 ? (
            ...
            invoices.map((inv) => {
              ...
              return (
                <div
                  key={inv._id}
                  className={`border rounded-xl overflow-hidden transition-all duration-300 print:border-none print:block ${
                    isExpanded
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                          <tr>
                            {[
                              ...
                              <th
                                key={h}
                                className={`px-4 py-3 font-black text-gray-500 uppercase text-[10px] ${
                        ...
                        <tfoot className="bg-gray-50">
                          <tr>
                            <td
                              colSpan="5"
                              className="px-4 py-3 text-right text-xs font-black uppercase text-gray-500"
                            >
                              Totals
                            </td>
                            ...
                            <td className="px-4 py-3 text-right font-black text-green-600 text-sm">
                              ৳{inv.totalPayment?.toLocaleString()}
                            </td>
                          </tr>
                        </tfoot>
