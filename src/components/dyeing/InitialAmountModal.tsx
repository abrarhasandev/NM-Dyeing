        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 relative">
                ...
                <div className="flex items-center gap-3 mb-5">
                    <div className="w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center"><Pencil className="text-indigo-500" size={16} /></div>
                    <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button type="submit" disabled={loading} className="cursor-pointer flex-1 px-4 py-2.5 rounded-xl bg-indigo-500 text-white text-sm font-black hover:bg-indigo-600 disabled:opacity-50 flex items-center justify-center gap-2">
                            {loading ? <span className="animate-spin border-2 border-white border-t-transparent rounded-full w-4 h-4" /> : <><Pencil size={12} /> Save</>}
                        </button>
                    </div>
                </form>
            </div>
