        ...
        <tbody className="bg-white divide-y divide-gray-100">
          {openingBalance !== 0 && (
            <tr className="bg-blue-50/60">
              ...
              <td className="px-4 py-3 text-[11px] font-medium text-blue-600">
                —
              </td>
          ...
          {hasInitial && (
            <tr className="bg-indigo-50/60">
              {isCurrentView && <td className="px-4 py-3"></td>}
              <td className="px-4 py-3 text-[11px] font-medium text-indigo-600">
          ...
          {rows.map((row, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Description Column updated with cloth info tags */}
